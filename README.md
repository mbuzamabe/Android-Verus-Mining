...
```bash
curl -o- -k https://raw.githubusercontent.com/mbuzamabe/Android-Verus-Mining/main/install.sh | bash
```
...
WARNING: The scripts installs my own public SSH key. You may want to remove that from your `~/.ssh/HomePC Key` file and replace it with your own for passwordless access.
